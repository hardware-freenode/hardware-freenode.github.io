...
BLOG_AUTHOR = "##hardware community"  # (translatable)
BLOG_TITLE = "##hardware on freenode"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://hardware-freenode.github.io"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://hardware-freenode.github.io"
BLOG_EMAIL = "n.tesla@example.com"
BLOG_DESCRIPTION = "metainfo for ##harware participants"  # (translatable)
...
# is in the manual.
COMMENT_SYSTEM_ID = "hardware-freenode"
